 ...
 * @package com.burgess.banana.local
 * @file BananaGuavaLevel1CacheProvider.java
 * @time 2018-05-17 17:34
 * @desc 本地缓存服务
 */
public class BananaGuavaLevel1CacheProvider implements BananaLevel1CacheProvider {

    private static final String _NULL = "NULL";

    private static final Logger logger = LoggerFactory.getLogger(BananaGuavaLevel1CacheProvider.class);
