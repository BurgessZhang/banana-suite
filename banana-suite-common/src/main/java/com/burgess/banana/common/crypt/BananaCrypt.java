 ...
 * @package com.burgess.banana.common.crypt
 * @file BananaCrypt.java
 * @time 2018-05-16 15:34
 * @desc
 */
public class BananaCrypt {
    ...
    public static String crypt(String salt, String plaintext, String encoding) {
        try {
            byte[] pwd = BananaCrypt.crypt(salt.getBytes(encoding), plaintext.getBytes(encoding));
    ...
    public static void main(String[] args) throws IOException {
        ...
        byte[] pwd = BananaCrypt.crypt("vakinge".getBytes(encoding), password.getBytes(encoding));
