...
import com.burgess.banana.common.util.BananaResourceUtils;
 ...
 * @package com.burgess.banana.common.lock.redis
 * @file BananaRedisLockCoordinator.java
 * @time 2018-05-16 21:06
 * @desc
 */
public class BananaRedisLockCoordinator {
    ...
    public BananaRedisLockCoordinator() {

        String mode = BananaResourceUtils.getProperty("jeesuite.lock.redis.mode", BananaResourceUtils.getProperty("jeesuite.cache.mode","standalone"));
        String server = BananaResourceUtils.getProperty("jeesuite.lock.redis.servers", BananaResourceUtils.getProperty("jeesuite.cache.servers"));
        String datebase = BananaResourceUtils.getProperty("jeesuite.lock.redis.datebase", BananaResourceUtils.getProperty("jeesuite.cache.datebase","0"));
        String password = BananaResourceUtils.getProperty("jeesuite.lock.redis.password", BananaResourceUtils.getProperty("jeesuite.cache.password"));
        String maxPoolSize = BananaResourceUtils.getProperty("jeesuite.lock.redis.maxPoolSize", BananaResourceUtils.getProperty("jeesuite.cache.maxPoolSize","100"));

        Validate.notBlank(server, "config[bananaSuite.lock.redis.servers] not found");
        ...
        if("standalone".equals(mode)){
            ...
            String masterName = ResourceUtils.getProperty("jeesuite.lock.redis.masterName", BananaResourceUtils.getProperty("jeesuite.cache.masterName"));
